...
#include <process.h>
 ...
 void raid0()
 {
     ...
     scanf("%ld",&n);
     fp1=fopen("C:/TC/raid/d1/file1.jpg","wb");
     fp2=fopen("C:/TC/raid/d2/file2.jpg","wb");
     fp3=fopen("C:/TC/raid/d3/file3.jpg","wb");
     do
     {
	    if(!feof(fp))
	   for(i=1;i<=n;i++)
   ...
   void raid1()
 {
     ...
     fp = fopen(filename, "rb");
     fp1=fopen("C:/TC/raid/d1/file1.jpg", "wb");
     fp2=fopen("C:/TC/raid/mirror/mirrer1.jpg", "wb");
...
void raid01()
 {
     ...
     fp = fopen(filename,"rb");
     fseek(fp,0,2);
     printf("size of file before striping is:%ld\n",ftell(fp));
     fseek(fp,0,0);
     printf("enter chunk size to stripe:");
     scanf("%ld",&n);
     fp1=fopen("C:/TC/raid/d1/file1.jpg", "wb");
     fp2=fopen("C:/TC/raid/d2/file2.jpg", "wb");
     fp3=fopen("C:/TC/raid/d3/file3.jpg", "wb");
     fp4=fopen("C:/TC/mirrer/d1/mirrer1.jpg", "wb");
     fp5=fopen("C:/TC/mirrer/d2/mirrer2.jpg", "wb");
     fp6=fopen("C:/TC/mirrer/d3/mirrer3.jpg", "wb");
     do
     {
	    if(!feof(fp))
	   for(i=1;i<=n;i++)
 ...
 void Reconstruct1()
 {
     ...
     printf("enter the chunk to stripe size: ");
     scanf("%ld",&n);
     fp1=fopen("C:/TC/raid/d1/file1.jpg", "rb");
     fp2=fopen("C:/TC/raid/d2/file2.jpg", "rb");
     fp3=fopen("C:/TC/raid/d3/file3.jpg", "rb");
     do
     {
     for(j=1;j<=n;j++)
     if((ch=getc(fp1))!=EOF)
  ...
  void Reconstruct2()
 {
     ...
     scanf("%s",filename);
     fp = fopen(filename, "wb");
     if((fp1=fopen("C:/TC/raid/d1/file1.jpg","rb"))==NULL)
     {
	printf("Original Hard disk has missed so i m using mirrored disk to reconstruct file\n");
	fclose(fp1);
	fp1 = fopen("C:/TC/raid/mirror/mirrer1.jpg", "rb");
      }
	  while(!feof(fp1))
	  {
		if((ch=getc(fp1))!=EOF)
 ...
 void Reconstruct3()
 {
	...
	fclose(fp1);
	fp1 = fopen("C:/TC/mirrer/d1/mirrer1.jpg","rb");
      }
    if((fp2=fopen("C:/TC/raid/d2/file2.jpg","rb"))==NULL)
     {
	printf("hard disk2 has missed so i m using mirred disk to reconstruct file\n");
	fclose(fp2);
	fp2=fopen("C:/TC/mirrer/d2/mirrer2.jpg","rb");
     }
     if((fp3=fopen("C:/TC/raid/d3/file3.jpg","rb"))==NULL)
     {
	printf("hard disk3 has missed so i m using mirred disk to reconstruct file\n");
	fclose(fp3);
	fp3=fopen("C:/TC/mirrer/d3/mirrer3.jpg","rb");
     }
...
void main()
{
     ...
     printf(" 6:Reconstuct the mirrared file \n\n 7:Reconstruct from RAID 0+1 \n\n 8:Reconstruct from RAID 10\n\n 9:For exit press any key");
     printf("\n***********************************\n");
